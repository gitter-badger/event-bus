...
describe Event::NameResolver do
  ...
  describe '#transform' do
    ...
    context 'when name is symbol' do
      ...
      it { expect(resolved_name).to eq Event::Events::MyEvent }
    end
